...
public interface MemberMapper {
	...
	@Select("SELECT USER_ID userId, USER_PWD userPwd, USER_NAME userName, BIRTHDAY, PHONE, EMAIL, " +
	...
	@Insert("INSERT INTO TB_MEMBER (USER_NO, USER_ID, USER_PWD, USER_NAME, BIRTHDAY, EMAIL, PHONE, SNS_AGREE, ENROLL_DATE, MANAGER, STATUS) " +
	        "VALUES (SEQ_USER_NO.NEXTVAL, #{userId}, #{userPwd}, #{userName}, #{birthday}, #{email}, #{phone}, #{snsAgree}, SYSDATE, DEFAULT, DEFAULT)")

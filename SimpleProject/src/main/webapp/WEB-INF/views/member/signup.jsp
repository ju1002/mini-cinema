        ...
        <div class="innerOuter">
            ...
            <form action="signup" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="birthday" placeholder="Please Enter birthDay" name="birthday"> <br>
					
                    <label for="phone">* Phone : </label>
                    <input type="text" class="form-control" id="phone" placeholder="Please Enter phone" name="phone"> <br>
                    
					<label for="email"> &nbsp; Email : </label>
                    <input type="text" class="form-control" id="email" placeholder="Please Enter Email" name="email"> <br>
                    
                    <label>* SNS 수신 동의</label><br>

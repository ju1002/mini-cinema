        ...
        <div class="innerOuter">
            ...
            <form action="edit" method="post">
                <div class="form-group">
				    ...
				    <input type="checkbox" name="genreList" value="G001" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G001') ? 'checked' : ''}>드라마
				    <input type="checkbox" name="genreList" value="G002" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G002') ? 'checked' : ''}>액션
				    <input type="checkbox" name="genreList" value="G003" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G003') ? 'checked' : ''}>코미디
				    <input type="checkbox" name="genreList" value="G004" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G004') ? 'checked' : ''}>스릴러
				    <input type="checkbox" name="genreList" value="G005" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G005') ? 'checked' : ''}>로맨스
				    <input type="checkbox" name="genreList" value="G006" ${fn:contains(sessionScope.loginMember.preferredGenres, 'G006') ? 'checked' : ''}>SF
